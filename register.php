   ...
   <div class="container">
      ...
      <div class="contant">
         <div class="text-contct login-form">
           ...
           <form action="#" >
           <label for="name"> اسم حسابك </label>
            <input type="text" name="name" id="name" />
            <label for="number">رقم الهاتف </label>
            <input type="number" name="Phnumber" id="number" />
            <label for="email">ادخل البريد الكتروني (اختياري)</label>
            <input type="email" name="email" id="email" />
            <label for="password">كلمة المرور </label>
            <input type="password" name="password" id="password" />
            <button type="submit" name="register" class="butm">تسجيل الدخول</button>
           </form>

                <div class="soshil">
                  <a href="login.php"> لدي حساب بل فعل </a>
                </div>
         </div>
      </div>
   </div>
