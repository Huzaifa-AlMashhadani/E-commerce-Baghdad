...
if(isset($_FILES['image1']) || isset($_FILES['image2'])){
    ...
    $sql = mysqli_query($con, "INSERT INTO orders(order_id, order_images, order_number, claent_name, cclaent_number, addres, order_price, descrption, statues)
    VALUES('$user_id', '{$images}', '{$orderNum}', '{$name}', '{$number}', '{$adrese}', '{$ClintPrice}', '{$descrption}', 'secses' )");
